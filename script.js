...
const specialistSets = JSON.parse(document.getElementById("specialists-data").textContent);
...
function setLanguage(lang){
  ...
  heroRotator.restart(); showcaseRotator.restart();
}
